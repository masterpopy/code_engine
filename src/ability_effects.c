    ...
    case 24: //switch ability per bank
             ...
             switch (last_used_ability)
        {
            ...
            case ABILITY_PSYCHIC_SURGE:
                ...
                break;
            case ABILITY_SHIELDS_DOWN:
                if((battle_participants[bank].species==POKE_MINIOR_CORE || (battle_participants[bank].species>=0x3EB && battle_participants[bank].species<=0x3F0)) && (battle_participants[bank].current_hp >= (battle_participants[bank].max_hp >> 1)) && !battle_participants[bank].status2.transformed)
                {
