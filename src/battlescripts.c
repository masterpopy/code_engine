...
const u16 sound_moves[] = {MOVE_BOOMBURST, MOVE_BUG_BUZZ, MOVE_CHATTER, MOVE_CLANGING_SCALES, MOVE_CONFIDE, MOVE_DISARMING_VOICE, MOVE_ECHOED_VOICE, MOVE_GRASS_WHISTLE, MOVE_GROWL, MOVE_HYPER_VOICE, MOVE_METAL_SOUND, MOVE_NOBLE_ROAR, MOVE_PARTING_SHOT, MOVE_PERISH_SONG, MOVE_RELIC_SONG, MOVE_ROAR, MOVE_ROUND, MOVE_SCREECH, MOVE_SING, MOVE_SNARL, MOVE_SNORE, MOVE_SPARKLING_ARIA, MOVE_SUPERSONIC, MOVE_UPROAR, 0xFFFF};
const u16 powder_moves[] = {MOVE_COTTON_SPORE, MOVE_POISON_POWDER, MOVE_POWDER, /*MOVE_RAGE_POWDER,*/ MOVE_SLEEP_POWDER, MOVE_SPORE, MOVE_STUN_SPORE, 0xFFFF}; //JeremyZ
...
const u16 biting_moves_table[] = {MOVE_BITE, MOVE_CRUNCH, MOVE_POISON_FANG, MOVE_FIRE_FANG, MOVE_ICE_FANG, MOVE_THUNDER_FANG, MOVE_HYPER_FANG, MOVE_PSYCHIC_FANGS, 0xFFFF};
...
const u16 user_thawing_moves[] = {MOVE_FLAME_WHEEL, MOVE_SACRED_FIRE, MOVE_SCALD, MOVE_FLARE_BLITZ, MOVE_FUSION_FLARE, MOVE_STEAM_ERUPTION, MOVE_BURN_UP, 0xFFFF};
const u16 ignore_targetstats_moves[] = {MOVE_SACRED_SWORD, MOVE_CHIP_AWAY, MOVE_DARKEST_LARIAT, MOVE_Z_ASH_GRENINJA, 0xFFFF};
