...
const u16 sound_moves[] = {MOVE_BOOMBURST, MOVE_BUG_BUZZ, MOVE_CHATTER, MOVE_CLANGING_SCALES, MOVE_CONFIDE,
        MOVE_DISARMING_VOICE, MOVE_ECHOED_VOICE, MOVE_GRASS_WHISTLE, MOVE_GROWL, MOVE_HEAL_BELL, MOVE_HYPER_VOICE, MOVE_METAL_SOUND,
        MOVE_NOBLE_ROAR, MOVE_PARTING_SHOT, MOVE_PERISH_SONG, MOVE_RELIC_SONG, MOVE_ROAR, MOVE_ROUND, MOVE_SCREECH,
        MOVE_SING, MOVE_SNARL, MOVE_SNORE, MOVE_SPARKLING_ARIA, MOVE_SUPERSONIC, MOVE_UPROAR, MOVE_Z_KOMMO_O, 0xFFFF};
...
const u16 ball_bomb_moves[] = {MOVE_ACID_SPRAY, MOVE_AURA_SPHERE, MOVE_BARRAGE, MOVE_BEAK_BLAST, MOVE_BULLET_SEED, MOVE_EGG_BOMB,
        ...
        MOVE_SLUDGE_BOMB, MOVE_WEATHER_BALL, MOVE_ZAP_CANNON, MOVE_POLLEN_PUFF, 0xFFFF};
...
const u16 ironfist_moves_table[] = {MOVE_BULLET_PUNCH, MOVE_COMET_PUNCH, MOVE_DIZZY_PUNCH, MOVE_DOUBLE_IRON_BASH, MOVE_DRAIN_PUNCH,
...
const u16 always_crit_hits[] = {MOVE_FROST_BREATH, MOVE_STORM_THROW, MOVE_Z_ASH_GRENINJA, MOVE_ZIPPY_ZAP, 0xFFFF};
...
const u8 aircurcontinues_bs[] = {0x10, 0x63, 2, 0x12, 0x40, 0, 0x3E};
const u8 aircurends_bs[] = {0x10, 0x64, 2, 0x12, 0x40, 0, 0x3E};
